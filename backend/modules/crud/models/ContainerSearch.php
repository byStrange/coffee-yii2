...
class ContainerSearch extends Container
{
    ...
    public function rules()
    {
        return [
            ...
            [['gap_size_x', 'gap_size_y', 'direction', 'created_at', 'updated_at'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['ilike', 'gap_size_x', $this->gap_size_x])
            ->andFilterWhere(['ilike', 'gap_size_y', $this->gap_size_y])
