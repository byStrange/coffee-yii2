...
/**
 * TextTranslationSearch represents the model behind the search form of `common\models\TextTranslation`.
 */
class TextTranslationSearch extends TextTranslation
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'text_source_id'], 'integer'],
            [['language_code', 'translation', 'created_at', 'updated_at'], 'safe'],
        ];
    }
